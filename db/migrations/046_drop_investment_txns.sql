...
--
-- Drop the v1 investment_txns table. It was populated from Kubera's
...
--
-- The companion code change (parsers/kubera.py + ingest.py + helper
-- scripts) lands together with this migration. After this commit:
--   - Kubera ingest no longer reads Cashflow.csv (it had no live readers)
