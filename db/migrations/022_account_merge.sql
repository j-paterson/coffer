...
--
-- Use cases:
--   * coinbase:exchange-bundle (the cost-basis importer) merged into the user's
--     canonical Coinbase account (e.g. simplefin:ACT-fc3b...)
--   * Multiple aggregator:<uuid> entries for the same real wallet, merged
--     into one canonical zerion: account
--   * Bank statement CSV import that creates a duplicate of a SimpleFIN
